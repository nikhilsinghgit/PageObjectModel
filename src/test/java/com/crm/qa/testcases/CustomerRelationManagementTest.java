...
public class CustomerRelationManagementTest {
	...
	public void freeCrmTitleTest() throws InterruptedException, IOException {
		...
		if (title.equals("#1 Free CRM software for any business - FreeCRM.com")) {
	...
	public static void getRunTimeInfoMessage(String messageType, String message) throws InterruptedException {
		...
		// js.executeScript("$.getScript('/Users/Nikhil/Documents/workspace/Test/src/testcases/jquery.growl.js')");
...
//		js.executeScript("$.growl.warning({ title: 'Warning!', message: 'your warning message goes here' });");
	...
	public static void takeScreenshot(String fileName) throws IOException{
		...
		FileUtils.copyFile(src, 
				new File("/Users/Nikhil/Documents/MyPOMFramework/PageObjectModel/screenshots/" + fileName +".png"));
